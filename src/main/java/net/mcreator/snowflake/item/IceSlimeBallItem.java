...
public class IceSlimeBallItem extends SnowFlakeModElements.ModElement {
	@ObjectHolder("snow_flake:ice_slime_ball")
	public static final Item block = null;
	public IceSlimeBallItem(SnowFlakeModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ice_slime_ball");
		}
