...
package net.mcreator.snowflake.entity;
...
import net.mcreator.snowflake.item.IceSlimeBallItem;
import net.mcreator.snowflake.entity.renderer.IceSlimeRenderer;
import net.mcreator.snowflake.SnowFlakeModElements;

@SnowFlakeModElements.ModElement.Tag
public class IceSlimeEntity extends SnowFlakeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1.2f, 1f))
					.build("ice_slime").setRegistryName("ice_slime");
	public IceSlimeEntity(SnowFlakeModElements instance) {
		super(instance, 26);
		FMLJavaModLoadingContext.get().getModEventBus().register(new IceSlimeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724839, -6684673, new Item.Properties().group(SnowFlakeTabItemGroup.tab))
				.setRegistryName("ice_slime_spawn_egg"));
	}
	...
	public static class CustomEntity extends SlimeEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(IceSlimeBallItem.block, (int) (1)));
		}
