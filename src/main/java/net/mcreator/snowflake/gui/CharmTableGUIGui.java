...
package net.mcreator.snowflake.gui;
...
public class CharmTableGUIGui extends SnowFlakeModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CharmTableGUIGui(SnowFlakeModElements instance) {
		super(instance, 42);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("charm_table_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 16, 45) {
			}));
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 43, 18) {
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 70, 45) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 43, 72) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 43, 45) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 124, 45) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				SnowFlakeMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
		...
		if (slotID == 5 && changeType == 1) {
			{
				...
				CharmTableCraftingProcedure.executeProcedure($_dependencies);
			}
		}
