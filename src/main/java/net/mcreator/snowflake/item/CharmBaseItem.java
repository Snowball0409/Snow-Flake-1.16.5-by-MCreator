...
public class CharmBaseItem extends SnowFlakeModElements.ModElement {
	@ObjectHolder("snow_flake:charm_base")
	public static final Item block = null;
	public CharmBaseItem(SnowFlakeModElements instance) {
		super(instance, 40);
	}
