...
public class IceFurnaceMeltingProcedure extends SnowFlakeModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "recipe"));
		{
			...
			IceFurnaceIsRecipeProcedure.executeProcedure($_dependencies);
		}
		...
		if (((new Object() {
			...
			if (((new Object() {
			...
			}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "timer")) >= 20)) {
				{
					...
					$_dependencies.put("y", y);
					$_dependencies.put("z", z);
					IceFurnaceResultProcedure.executeProcedure($_dependencies);
				}
			}
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				...
				$_dependencies.put("y", y);
				$_dependencies.put("z", z);
				IceFurnaceFuelProcedure.executeProcedure($_dependencies);
			}
		}
		if (((new Object() {
			public double getValue(IWorld world, BlockPos pos, String tag) {
			...
			if (!world.isRemote()) {
				...
				if (_tileEntity != null)
					...
					}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "fuel")) - 10));
				if (world instanceof World)
					((World) world).notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
			if (((new Object() {
